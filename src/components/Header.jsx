...
const Header = () => {
    return (
        <header className="max-w-[90vw] mx-auto flex items-center justify-between h-12 md:h-20">
            ...
            <nav className="flex items-center justify-center md:justify-normal gap-10 md:font-light md:text-lg md:static fixed bottom-2 bg-sky-600 md:bg-transparent w-[90vw] md:w-fit py-3 md:py-0 px-4 text-white md:text-black font-bold md:px-0 z-20 text-base rounded-full">
